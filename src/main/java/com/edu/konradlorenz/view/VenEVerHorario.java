...
public class VenEVerHorario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblHorarioAsignado.setFont(new java.awt.Font("Century Gothic", Font.BOLD, 18)); // NOI18N
        lblHorarioAsignado.setText("Horario Asignado");

        lblDesde.setFont(new java.awt.Font("Century Gothic", Font.BOLD, 14)); // NOI18N
        lblDesde.setText("Desde el:");

        txtFechaIni.setEditable(false);
        txtFechaIni.setBackground(new java.awt.Color(228, 235, 247));
        txtFechaIni.setFont(new java.awt.Font("Century Gothic", Font.BOLD, 14)); // NOI18N
        txtFechaIni.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));

        lblHasta.setFont(new java.awt.Font("Century Gothic", Font.BOLD, 14)); // NOI18N
        lblHasta.setText("Hasta el:");

        txtFechaFin.setEditable(false);
        txtFechaFin.setBackground(new java.awt.Color(228, 235, 247));
        txtFechaFin.setFont(new java.awt.Font("Century Gothic", Font.BOLD, 14)); // NOI18N
        ...
        txtHoraEnt.setFont(new java.awt.Font("Century Gothic", Font.BOLD, 14)); // NOI18N
        ...
        txtHoraSal.setFont(new java.awt.Font("Century Gothic", Font.BOLD, 14)); // NOI18N
